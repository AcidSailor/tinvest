...
func (s marketDataService) GetClosePrices(
...
func (s marketDataService) GetLastPrices(
...
func (s marketDataService) GetLastTrades(
...
func (s marketDataService) GetMarketValues(
...
func (s marketDataService) GetTechAnalysis(
...
func (s marketDataService) GetTradingStatus(
...
func (s marketDataService) GetTradingStatuses(
